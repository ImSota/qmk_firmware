...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        ...
        EISU,            KC_LCTL, KC_LGUI,    LSFT_T(KC_SPC), TT(LOWER), TT(RAISE), KC_BSPC, KC_ENT, KC_LALT,                  KANA2
    ),
    ...
    [NAGINATA] = LAYOUT(
        ...
        _______,              _______, _______, NG_SHFT, _______,  _______, _______, _______, _______,                 _______
    ),
     /* LOWER
      * ┌───┬───┬───┬───┬───┬───┐               ┌───┬───┬───┬───┬───┬───┐
    ...
    [RAISE] = LAYOUT(
        ...
        _______,                      NG_TAYO, _______, _______,  _______,   _______, _______, _______,  _______,                    _______
    )
};
